       ...
       <section className='bg-white p-5 lg:p-10'>
        <div className='bg-primary p-2 lg:p-5 rounded-tl-[50px]  lg:rounded-tl-[100px] rounded-br-[50px] lg:rounded-br-[100px] lg:mx-5'>
          <div className='w-4/5 mx-auto'>
            ...
            <p className='font-medium pb-2 text-xs lg:text-lg text-white '>The management of <span className='font-bold text-xl lg:text-2xl underline'>Alpha Group</span> tries to maintain our customers and clients trust. Management is responsible for the health and safety of our employees and prevention of harm to the environment.</p>
